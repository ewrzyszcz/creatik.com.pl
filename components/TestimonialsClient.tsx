...
export default function TestimonialsClient({ reviews, rating, totalReviews }: TestimonialsClientProps) {
  return (
    <section className="py-16 bg-gray-50 border-y border-gray-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className={`flex flex-col md:flex-row items-center justify-between ${reviews.length > 0 ? 'mb-16' : ''} gap-8 bg-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100`}
        >
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                Dlaczego klienci wybierają Creatik
              </h2>
            </div>
            {rating > 0 && (
